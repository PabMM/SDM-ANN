%% Validation simulations for 2nd order SC Multi Bit SDM model
...
for k = 1:2
    val = validation{k};
    data_path = [cd,'/VAL-DS/Multiple-Iterations-',val,'/classifier',classifier_model,'_2ndSCSDM_MultiBit_val_'];
...
function SCANN2ndMBSDMval29 = importfile_SC(filename, dataLines)
    ...
    % Import the data
    SCANN2ndMBSDMval29 = readtable(filename, opts);
